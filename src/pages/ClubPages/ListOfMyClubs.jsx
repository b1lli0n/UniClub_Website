    ...
    useEffect(() => {
        const fetchClubs = async () => {
            ...
            try {
                ...
                // Flatten structure: merge club info với membership info
                const mappedClubs = membershipsArray
                    .map((membership) => {
                        ...
                        return {
                            ...
                            member_total: club.member_total,
                            events: club.events,
                            event_total: club.event_total,
                ...
                if (sortBy === 'members') {
                    filtered = [...filtered].sort(
                        (a, b) => (b.members ?? b.member_total ?? 0) - (a.members ?? a.member_total ?? 0)
                    );
                } else if (sortBy === 'members-asc') {
                    filtered = [...filtered].sort(
                        (a, b) => (a.members ?? a.member_total ?? 0) - (b.members ?? b.member_total ?? 0)
                    );
                }
