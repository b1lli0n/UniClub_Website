...
export const mapEvent = (event) => {
    ...
    return {
        ...
        startAt: event.start_at || event.start_time,
        endAt: event.end_at || event.end_time,
        capacity: event.capacity,
        public: event.is_public !== undefined ? event.is_public : true,
        mediaUrls: event.media_urls || [],
        progressStatus: PROGRESS_STATUS_MAP[event.progress_status] || 0,
